...
def write_name_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
    ...
    my_turtle_cursor.pendown()
    time.sleep(1)
    my_turtle_cursor.write("SK Khandokar", font=("sans-serif", 19, "bold"))
...
write_birthday_inside_circle("#000000", -80, y_coordinate + 205)
write_name_inside_circle("#000000", -50, y_coordinate + 170)
